...
local Cheat = {
    ...
    HitboxExpander = {Enabled = false, Size = 15}
}
...
-- Hitbox Expander
AddToggle("Hitbox Expander", Cheat.HitboxExpander.Enabled, function(v) Cheat.HitboxExpander.Enabled = v end)
AddSlider("Hitbox Size", 5, 120, 15, function(v) Cheat.HitboxExpander.Size = v end)
...
RunService.RenderStepped:Connect(function()
    ...
    -- Hitbox Expander
    if Cheat.HitboxExpander.Enabled then
        for _, plr in ipairs(Players:GetPlayers()) do
            if plr ~= LocalPlayer and plr.Character then
                ...
                if hrp then
                    ...
                    hrp.Size = Vector3.new(Cheat.HitboxExpander.Size, Cheat.HitboxExpander.Size, Cheat.HitboxExpander.Size)
