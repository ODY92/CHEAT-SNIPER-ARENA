...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "CHEAT MENU - ODY92" then
		LoadingFrame.Version.Text = "ODY92"
	end
...
if useStudio then
	...
	----RayfieldLibrary:Notify({Title = "CHEAT MENU - ODY92", Content = "Welcome to Rayfield. These - are the brand new notification design for Rayfield, with custom sizing and Rayfield calculated wait times.", Image = 4483362458})
